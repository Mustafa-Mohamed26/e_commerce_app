...
class _HomeTabState extends State<HomeTab> {
          ...
          BlocBuilder<HomeTabViewModel, HomeTabSates>(
            ...
            builder: (context, state) {
              if (state is BrandErrorState) {
                ...
                return _buildCategoryBrandSec(state.brandList ?? []);
              } else {
                return MainLoadingWidget();
              }
            },
  ...
  _lineBreak({required String name}) {
    return Row(
  ...
  Widget _buildCategoryBrandSec(List<Category> list) {
    return SizedBox(
      height: 250.h,
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) =>
            CategoryBrandItem(category: list[index]),
      ),
    );
  }
}
